...
AuthenticationModel.prototype.setInitParameters=function(){
	...
	var message={
			method:"GET",
			action: "http://yellowjacket.ethz.ch/tools/service/authentication.php/request_token",
			parameters: [
...
AuthenticationModel.prototype.getRequestToken=function(){
	var self=this;
	$.ajax({
		url:  'http://yellowjacket.ethz.ch/tools/service/authentication.php/request_token',
		type : 'GET',
		dataType : 'json',
...
AuthenticationModel.prototype.obtainAuthorization = function(){
    var self=this;
    var url='http://yellowjacket.ethz.ch/tools/service/authentication.php/authorize';
    var method="GET";
    $.ajax({
	url: url,
	type : method,
